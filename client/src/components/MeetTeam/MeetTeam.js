  ...
  render() {
    ...
    return (
      <div className="meet-team">
        ...
        <div
          className="alec"
          style={{ margin: '15px', width: '290px', display: 'inline-block' }}
        >
          <Card
          ...
          <Card
            ...
            reveal={
              <p style={{ marginTop: '30px', textAlign: 'left' }}>
                ...
                beach island. He comes from a small town in rural Tennessee. He
                enjoys the nitty gritty when it comes to coding.If you need
                someone adaptable, he's your guy.
              </p>
            }
          >
        ...
        >
          <Card
            ...
            reveal={
              <p style={{ marginTop: '30px', textAlign: 'left' }}>
                Rachel has a unique and heart-warming personality that brings a
                happy work environment for her colleagues. After working with
                children for 5 years , she was ready for a career change and
                came to Lambda School. Rachel loves building projects with her
